              ...
              <nav className='level navbar-has-shadow py-1'>
                ...
                <div className='navbar-end'>
                  <div className='navbar-item'>
                    <button onClick={''} className='button is-black'>Connect To Near</button>
                    {/* {isConnected ? ("Connected") : (<button onClick={() => connect} className='button is-link'>Connect Wallet</button>)} */}
                    {isConnected ? (<button onClick={""} className='button is-link' disabled>Connected</button>) : (<button onClick={""} className='button is-link'>Connect </button>)}
                  </div>
                </div>
              </nav>
            </div>
